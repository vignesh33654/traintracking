...
export default function DarkModeToggle() {
  ...
  return (
    <button
      ...
      className={cn(
        "fixed top-4 right-4 z-50 flex items-center gap-2 rounded-lg bg-bg-1 px-4 py-2 text-text-primary transition-colors duration-200 hover:bg-bg-2 focus-ring"
      )}
