      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card
            ...
            description="Another example card demonstrating responsive design and consistent spacing."
            className="md:col-span-2"
          />

          <Card
            title="Compact Card"
            description="A smaller card variant that still follows the same design system principles."
          />
        </div>
      </div>
    </div>
